...
/**
 * OpenClose filter form base class.
 *
 * @package    cce
 * @subpackage filter
 ...
 */
abstract class BaseOpenCloseFormFilter extends MeasurementFormFilter
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema->setNameFormat('open_close_filters[%s]');
  }
