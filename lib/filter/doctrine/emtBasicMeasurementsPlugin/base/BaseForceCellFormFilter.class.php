...
/**
 * ForceCell filter form base class.
 *
 * @package    cce
 * @subpackage filter
 ...
 */
abstract class BaseForceCellFormFilter extends MeasurementFormFilter
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema->setNameFormat('force_cell_filters[%s]');
  }
