...
abstract class BaseEntityFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'error_lower_limit'          => new sfWidgetFormFilterInput(),
      'warning_lower_limit'        => new sfWidgetFormFilterInput(),
      'warning_upper_limit'        => new sfWidgetFormFilterInput(),
      'error_upper_limit'          => new sfWidgetFormFilterInput(),
      'social_security_number'     => new sfWidgetFormFilterInput(),
      'born_at'                    => new sfWidgetFormFilterInput(),
      'address'                    => new sfWidgetFormFilterInput(),
      'calendar_url'               => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'error_lower_limit'          => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'warning_lower_limit'        => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'warning_upper_limit'        => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'error_upper_limit'          => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
