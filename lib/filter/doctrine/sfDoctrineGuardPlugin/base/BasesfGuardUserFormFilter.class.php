...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'patient_id'       => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('PatientRole'), 'add_empty' => true)),
      'observer_id'      => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ObserverRole'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'patient_id'       => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('PatientRole'), 'column' => 'id')),
      'observer_id'      => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('ObserverRole'), 'column' => 'id')),
