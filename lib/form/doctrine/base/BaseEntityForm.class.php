...
abstract class BaseEntityForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'error_lower_limit'          => new sfWidgetFormInputText(),
      'warning_lower_limit'        => new sfWidgetFormInputText(),
      'warning_upper_limit'        => new sfWidgetFormInputText(),
      'error_upper_limit'          => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'error_lower_limit'          => new sfValidatorNumber(array('required' => false)),
      'warning_lower_limit'        => new sfValidatorNumber(array('required' => false)),
      'warning_upper_limit'        => new sfValidatorNumber(array('required' => false)),
      'error_upper_limit'          => new sfValidatorNumber(array('required' => false)),
      ...
      'calendar_url'               => new sfValidatorString(array('max_length' => 255)),
